...
local zh = {
    ...
    ["[Scan] Scan local cache"] = "【扫描】扫描本地缓存",
    ["Scan local cache"] = "扫描本地缓存",
    ["Scanning local cache..."] = "正在扫描本地缓存……",
    ["Scan complete. %1 added, %2 updated."] = "扫描完成。新增 %1 项，更新 %2 项。",
    ["Found %1 untracked item(s) in the new directory. Add them to the library?"] = "在新目录中发现 %1 项未记录的内容。是否添加到书库？",
    ["Add"] = "添加",
    ["Skip"] = "跳过",
    ["Added %1 item(s) to the library."] = "已将 %1 项添加到书库。",
