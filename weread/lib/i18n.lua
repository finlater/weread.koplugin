...
local zh = {
    ...
    ["Concurrent requests: chapters %1 · comments %2 · images %3"] = "并发请求：章节 %1 · 评论 %2 · 图片 %3",
    ["Automatic concurrency based on device memory"] = "根据设备内存自动设置并发数",
    ["Detected memory: %1 MB"] = "检测到内存：%1 MB",
    ["Detected memory: unavailable"] = "检测内存：不可用",
    ["Subprocess concurrency unavailable"] = "当前平台不支持子进程并发",
    ["Chapter requests: %1"] = "章节请求：%1",
    ["Comment requests: %1"] = "评论请求：%1",
    ["Image requests: %1"] = "图片请求：%1",
    ["Chapter requests"] = "章节请求",
    ["Comment requests"] = "评论请求",
    ["Image requests"] = "图片请求",
    ["%1 concurrency (1–8)"] = "%1并发数（1–8）",
    ...
    ["Downloading chapters in parallel · %1 workers"] = "正在并发下载章节 · %1 个工作进程",
    ["Downloading chapters in parallel · %1/%2"] = "正在并发下载章节 · %1/%2",
    ["Downloading thoughts in parallel %1/%2 · chapter %3/%4"] = "正在并发下载想法 %1/%2 · 章节 %3/%4",
    ["Downloading images in parallel %1/%2 · chapter %3/%4"] = "正在并发下载图片 %1/%2 · 章节 %3/%4",
