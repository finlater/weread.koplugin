...
local zh = {
    ...
    ["Sync failed; showing the cached bookshelf."] = "同步失败，显示缓存的书架。",
    ["Load bookshelf failed:\n%1\n\nYour login looks valid, so this may be a temporary WeRead server issue. You can still find and read books via search."] = "加载书架失败：\n%1\n\n登录状态看起来正常，可能是微信读书服务端的临时问题。你仍可以通过搜索找到并阅读书籍。",
    ["%1 chapters"] = "%1 章",
    ["Not loaded"] = "未加载",
