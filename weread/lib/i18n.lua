...
local zh = {
    ...
    ["Match underlines and thoughts for “%1”?\nOnly chapters in this file are processed. Automatic downloads require both chapter prefetch and annotation prefetch; position matching is always manual."] = "是否匹配《%1》的划线和想法？\n仅处理当前文件包含的章节。自动下载需同时开启章节预下载和预下载划线想法；位置匹配始终由你手动发起。",
    ["Start matching"] = "开始匹配",
    ["WeRead"] = "微信读书",
    ...
    ["Saving thoughts %1/%2 · chapter %3/%4"] = "正在保存想法 %1/%2 · 章节 %3/%4",
    ["Thought data format has been upgraded. Match again to download current data."] = "想法数据格式已升级，需要重新匹配。",
