...
local zh = {
    ...
    ["Book images"] = "书籍图片",
    ["Download translation"] = "下载译文",
    ["Download the WeRead full-text translation together with the original. Only affects books you have already translated in the WeRead app."] = "下载时一并保留微信读书的全文译文（原文+译文）。仅对你已在微信读书 App 里翻译过的书生效。",
